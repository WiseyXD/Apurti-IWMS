  ...
  const features = [
    {
      ...
      description:
        "Automatically organize your stock using QR codes or RFID tags, to optimize space and saving time and reducing errors.",
    ...
    },
    {
      ...
      description:
        "Track your inventory in real-time with automated updates and instant restocking alerts.",
    ...
    },
    {
      ...
      description:
        "Apurti generates detailed reports and data analysis to help you forecast stock trends and make informed decisions.",
    ...
    },
    {
      ...
      description:
        "Apurti integrates effortlessly with your existing systems and automates key warehouse processes like restocking and space optimization.",
      ...
      <div className="relative z-20 py-10 max-w-7xl mx-auto">
        <div className="px-8">
          <h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">
            Revolutionize Your Warehouse Management with Apurti
          </h4>
      ...
      <div className="flex flex-row-reverse">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileHover="whileHover"
            whileTap="whileTap"
            className="rounded-xl -ml-4 mt-4 p-1 bg-white dark:bg-neutral-800 dark:border-neutral-700 border border-neutral-100 flex-shrink-0 overflow-hidden"
          >
            <Image
              src={image}
              alt="bali images"
